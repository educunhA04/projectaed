...
/**
    * @class Student
    * @brief Represents a Student by its Name, Student Code and Schedule (list of Classes)
    */
...
class Student{
    ...
    public:
        ...
        /// Overloaded less-than operator for comparing Student objects based on student code
