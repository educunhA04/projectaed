...
class Classes{
    private:
        string classCode;
        string ucCode;
        vector<TimeType> timetable;

    public:
        Classes(){

        }
        Classes(const string& cCode, const string& uCode, const vector<TimeType>& newTimetable) {
        ...
        vector<TimeType> getTimetable() const {return timetable;}
